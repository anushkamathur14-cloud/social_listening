...
export const config = {
  ...
  redditSubreddits: (process.env.REDDIT_SUBREDDITS ?? "food,beer,nyc,LosAngeles").split(","),
  redditKeywords: (process.env.REDDIT_KEYWORDS ?? "beer,snacks,delivery,hungry,storm,delay").split(","),
  ...
  brandName: process.env.BRAND_NAME ?? "Bites & Brews",
